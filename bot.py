...
async def strt(event):
    await event.reply(f"Hi. I'm a force subscribe bot made specially for @{channel}!\n\nCheckout @ABOUTPRATHEEK :)", buttons=[Button.url("Channel", url=f"https://t.me/{channel}"), Button.url("Repository", url="https://github.com/PratheekXd/ForceSub")])

    
print("ForceSub Bot has started.\nDo visit @ABOUTPRATHEEK!")
